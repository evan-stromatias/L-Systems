...
class BracketedOlSystemFig124b(Lsystem):
    """Figure 1.24: Examples of plant-like structures generated by bracketed OL-systems. (b) Edge-rewriting system."""
...
if __name__ == '__main__':
    lsystem = BracketedOlSystemFig124b()
    turtle_conf = TurtleConfiguration(angle=20, initial_heading_angle=90)
    renderer = LSystemRenderer(lsystem, turtle_conf, title="Bracketed OL-systems Fig 1.24b")
    renderer.draw()
